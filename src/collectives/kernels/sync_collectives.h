...
constexpr int32_t TILEXR_BLOCK_NUM_MULTI = 2;
#else
constexpr int32_t TILEXR_BLOCK_NUM_MULTI = 1;
#endif
...
public:
    ...
    __aicore__ inline void Init(int rank, int rankSize, GM_ADDR *shareAddrs)
    {
        ...
        this->blockNum = GetBlockNum() * TILEXR_BLOCK_NUM_MULTI;
        segmentCount = GetBlockNum() * TILEXR_BLOCK_NUM_MULTI * FLAG_UNIT_INT_NUM;
